-- Restore the customer portal auto-invite block that was accidentally dropped
-- when submit_signature was rewritten in 20260518050000 to add extra PDF params.
-- The block runs unconditionally (outside the v_log_aktiv email gate) and inserts
-- into kund_portal_invite_queue, which triggers the portal welcome email.
