-- Fix: label the main signed PDF button by document type instead of generic "PDF".
-- "Ladda ner signerad PDF" → "Ladda ner Signerad Offert / Order / ÄTA-arbete / Dokument"
