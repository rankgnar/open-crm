-- Expose specifikation_pdf_url and tidplan_pdf_url through get_signing_doc so
-- the signing portal can render the extra PDFs in tabs when split-PDF mode is used.
