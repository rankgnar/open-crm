-- Extend submit_signature to include download buttons for signed
-- specifikation and tidplan PDFs in the customer confirmation email.
-- Adding parameters requires dropping and re-creating the function.

BEGIN;

DROP FUNCTION IF EXISTS submit_signature(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
