-- Restore the personnummer sync that was accidentally dropped from submit_signature
-- when the function was rewritten in 20260513100000_remove_projekt_status_automation.sql.
-- Every subsequent rewrite (20260518050000..064000) also missed it.
-- The sync block writes the customer's personnummer back to kunder when they sign,
-- or logs a mismatch note in projekt_anteckningar if the values differ.
