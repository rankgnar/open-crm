...
const MATERIAL_PRESETS: MaterialPreset[] = [
  { name: 'Parkett',   unit: 'm²', coveragePerM2: 1.1,  unitPrice: 0 },
  { name: 'Golvfolie', unit: 'm²', coveragePerM2: 1.05, unitPrice: 0 },
  { name: 'Spackel',   unit: 'kg', coveragePerM2: 2.0,  unitPrice: 0 },
  { name: 'Golvlist',  unit: 'm',  coveragePerM2: 2.5,  unitPrice: 0 },
]
...
export function GolvKalkylator({ input, avdragPresets, onUpdate }: Props) {
  ...
  return (
    <div className="flex flex-col divide-y divide-border">
      ...
      <div className="px-6 py-6">
        <SectionHeader title="Avdrag — trappor & genomföringar" sub={totalDeduction > 0 ? `−${totalDeduction.toLocaleString('sv-SE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} m²` : undefined} />
