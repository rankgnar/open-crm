export type OrderStatus = 'Utkast' | 'Skickad' | 'Godkänd' | 'Avvisad'
...
export interface OrderWithRader extends Order {
  rader: OrderRad[]
}

export interface CreateOrderRadInput {
  beskrivning: string
  antal?: number
  enhet?: string
  a_pris?: number
...
export const STATUS_FARG: Record<OrderStatus, { dot: string; text: string }> = {
